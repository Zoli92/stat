...
Tételezzük fel, hogy a minta elemei ugyanabból a normális eloszlásból származnak, amelynek a paramétereit nem ismerjük. Az átlagra szimmetrikus, 95% megbízhatóságú konfidenciaintervallum az eloszlás várható értékére:
```{r}
